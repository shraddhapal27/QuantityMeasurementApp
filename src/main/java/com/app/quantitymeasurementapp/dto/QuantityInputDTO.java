...
public class QuantityInputDTO {
	...
	@Schema(description = "First quantity (the 'this' operand)", example = "{\"value\":1.0,\"unit\":\"FEET\",\"measurementType\":\"LengthUnit\"}")
	private QuantityDTO thisQuantityDTO;

	@Valid
	@NotNull(message = "thatQuantityDTO must not be null")
	@JsonProperty("thatQuantityDTO")
	@Schema(description = "Second quantity (the 'that' operand)", example = "{\"value\":12.0,\"unit\":\"INCHES\",\"measurementType\":\"LengthUnit\"}")
